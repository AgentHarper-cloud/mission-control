...
const channelData: ChannelStats[] = [
  ...
  },
  {
    ...
    color: "#000000",
    metrics: {
      today: { primary: { label: "FOLLOWERS", value: "—" }, secondary: { label: "IMPRESSIONS", value: "—" }, tertiary: { label: "ENGAGE %", value: "—" }, growth: 0 },
      "7d": { primary: { label: "FOLLOWERS", value: "—" }, secondary: { label: "IMPRESSIONS", value: "—" }, tertiary: { label: "ENGAGE %", value: "—" }, growth: 0 },
      "30d": { primary: { label: "FOLLOWERS", value: "—" }, secondary: { label: "IMPRESSIONS", value: "—" }, tertiary: { label: "ENGAGE %", value: "—" }, growth: 0 },
      "90d": { primary: { label: "FOLLOWERS", value: "—" }, secondary: { label: "IMPRESSIONS", value: "—" }, tertiary: { label: "ENGAGE %", value: "—" }, growth: 0 },
      ytd: { primary: { label: "FOLLOWERS", value: "—" }, secondary: { label: "IMPRESSIONS", value: "—" }, tertiary: { label: "ENGAGE %", value: "—" }, growth: 0 },
    },
  },
  {
    id: "linkedin",
  ...
  },
  {
    ...
    color: "#9333EA",
    metrics: {
      today: { primary: { label: "SUBSCRIBERS", value: "12.4K" }, secondary: { label: "DOWNLOADS", value: "892" }, tertiary: { label: "AVG LISTEN", value: "34m" }, growth: 0.3 },
      "7d": { primary: { label: "SUBSCRIBERS", value: "12.4K" }, secondary: { label: "DOWNLOADS", value: "6.2K" }, tertiary: { label: "AVG LISTEN", value: "36m" }, growth: 2.4 },
      "30d": { primary: { label: "SUBSCRIBERS", value: "12.4K" }, secondary: { label: "DOWNLOADS", value: "28.4K" }, tertiary: { label: "AVG LISTEN", value: "35m" }, growth: 11.2 },
      "90d": { primary: { label: "SUBSCRIBERS", value: "12.4K" }, secondary: { label: "DOWNLOADS", value: "84.1K" }, tertiary: { label: "AVG LISTEN", value: "34m" }, growth: 28.6 },
      ytd: { primary: { label: "SUBSCRIBERS", value: "12.4K" }, secondary: { label: "DOWNLOADS", value: "215K" }, tertiary: { label: "AVG LISTEN", value: "33m" }, growth: 67.4 },
    },
  },
];

// Sample content data matching Mission Control structure
const contentData: ContentItem[] = [
  {
    id: "1",
    title: "How I Built My First AI Employee",
    copy: "The complete breakdown of building an AI workforce that generates revenue 24/7. Here's exactly what I did...\n\n🔥 Step 1: Identify the repetitive tasks\n💡 Step 2: Build the automation\n🚀 Step 3: Scale it up",
    image_url: "https://images.unsplash.com/photo-1677442136019-21780ecad995?w=400&h=225&fit=crop",
    media_type: "video",
    media_urls: null,
    video_url: "https://example.com/video1.mp4",
    video_thumbnail: "https://images.unsplash.com/photo-1677442136019-21780ecad995?w=400&h=225&fit=crop",
    platform: "youtube",
    status: "pending",
    scheduled_for: null,
    campaign: "AI Workforce Launch",
    hashtags: "#AI #Automation #AIWorkforce #Entrepreneurship",
    created_by: "solomon",
    approved_by: null,
    rejected_by: null,
  ...
  {
    id: "2",
    title: "The $50K AI Workforce Case Study",
    copy: "Real numbers, real results. See how one client built a $50K/month AI operation in just 90 days.\n\nThis isn't theory—this is what actually happened.",
    image_url: "https://images.unsplash.com/photo-1485827404703-89b55fcc595e?w=400&h=225&fit=crop",
    media_type: "video",
    media_urls: null,
    video_url: null,
    ...
    hashtags: "#CaseStudy #AIBusiness #Success",
    created_by: "solomon",
    approved_by: null,
    rejected_by: null,
    rejection_reason: null,
  ...
  },
  {
    ...
    copy: "Why 99% of people never monetize AI — and how to be in the 1%.\n\nThe secret? Stop consuming. Start creating.\n\nDrop a 🔥 if you're ready to build.",
    image_url: "https://images.unsplash.com/photo-1531746790731-6c087fecd65a?w=400&h=225&fit=crop",
    media_type: "reel",
    media_urls: null,
    video_url: "https://example.com/reel1.mp4",
    video_thumbnail: "https://images.unsplash.com/photo-1531746790731-6c087fecd65a?w=400&h=225&fit=crop",
    platform: "instagram",
    status: "pending",
    scheduled_for: null,
    campaign: "Motivation",
    hashtags: "#AIMonetization #BuildInPublic #Entrepreneur",
    created_by: "solomon",
    approved_by: null,
    rejected_by: null,
    rejection_reason: null,
  ...
  {
    id: "4",
    title: "Workshop Highlight: Live Build Session",
    copy: "Watch me build a complete AI sales agent in 45 minutes — real-time.\n\nNo fluff. No theory. Just pure execution.",
    ...
    video_thumbnail: "https://images.unsplash.com/photo-1633356122544-f134324a6cee?w=400&h=225&fit=crop",
    platform: "tiktok",
    status: "scheduled",
    scheduled_for: "2026-03-06T09:00:00Z",
    campaign: "Workshop Promo",
    hashtags: "#AIAgent #LiveBuild #TechTok",
    created_by: "solomon",
    approved_by: "aaron",
    rejected_by: null,
    rejection_reason: null,
  ...
  {
    id: "5",
    title: "Behind the Scenes: Building AI Systems",
    copy: "A day in the life building AI monetization systems from scratch.\n\nCoffee ☕ + Code 💻 + Results 📈",
    image_url: "https://images.unsplash.com/photo-1550751827-4bd374c3f58b?w=400&h=225&fit=crop",
    media_type: "carousel",
    media_urls: [
      "https://images.unsplash.com/photo-1550751827-4bd374c3f58b?w=400&h=225&fit=crop",
      "https://images.unsplash.com/photo-1620712943543-bcc4688e7485?w=400&h=225&fit=crop",
    ...
    hashtags: "#BTS #AILife #BuildingInPublic",
    created_by: "solomon",
    approved_by: "aaron",
    rejected_by: null,
    rejection_reason: null,
  ...
  {
    id: "6",
    title: "Client Testimonial: Sarah's $20K Month",
    copy: "Sarah went from zero to $20K/month with AI in just 90 days.\n\nHere's her story in her own words...",
    image_url: "https://images.unsplash.com/photo-1573164713988-8665fc963095?w=400&h=225&fit=crop",
    media_type: "video",
    media_urls: null,
    video_url: null,
    video_thumbnail: null,
    ...
    hashtags: "#ClientSuccess #AIBusiness #Transformation",
    created_by: "solomon",
    approved_by: "aaron",
    rejected_by: null,
    rejection_reason: null,
  ...
  {
    id: "7",
    title: "3 Tools You Need to Start Today",
    copy: "The exact stack I use to build $50K/month AI systems:\n\n1️⃣ ChatGPT + Custom Instructions\n2️⃣ Make.com for automations\n3️⃣ GHL for client delivery\n\nSave this post 📌",
    image_url: "https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?w=400&h=225&fit=crop",
    media_type: "image",
    media_urls: null,
    video_url: null,
    video_thumbnail: null,
    ...
    hashtags: "#AITools #TechStack #Productivity",
    created_by: "solomon",
    approved_by: null,
    rejected_by: null,
    rejection_reason: null,
  ...
  {
    id: "8",
    title: "Why AI Employees Outperform Humans",
    copy: "The 5 advantages AI workers have over traditional employees:\n\n✅ 24/7 availability\n✅ Perfect consistency\n✅ Instant scaling\n✅ Zero HR drama\n✅ Fraction of the cost",
    image_url: "https://images.unsplash.com/photo-1620712943543-bcc4688e7485?w=400&h=225&fit=crop",
    media_type: "image",
    media_urls: null,
    video_url: null,
    video_thumbnail: null,
    ...
    hashtags: "#AIvsHuman #FutureOfWork #AIWorkforce",
    created_by: "solomon",
    approved_by: null,
    rejected_by: "aaron",
    rejection_reason: "Tone feels too aggressive against human workers. Soften the messaging.",
    metadata: null,
    created_at: "2026-02-28T15:00:00Z",
  },
  {
    id: "9",
    title: "From Employee to AI Empire",
    copy: "The mindset shift that changes everything.\n\nYou're not building a job. You're building an army.\n\nAn army that works for you 24/7.",
    image_url: "https://images.unsplash.com/photo-1488229297570-58520851e868?w=400&h=225&fit=crop",
    media_type: "reel",
    media_urls: null,
    video_url: "https://example.com/reel3.mp4",
    video_thumbnail: "https://images.unsplash.com/photo-1488229297570-58520851e868?w=400&h=225&fit=crop",
    platform: "tiktok",
    status: "pending",
    scheduled_for: null,
    campaign: "Mindset",
    hashtags: "#MindsetShift #AIEmpire #Entrepreneurship",
    created_by: "solomon",
    approved_by: null,
    rejected_by: null,
    rejection_reason: null,
